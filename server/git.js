...
const getAllData = async (accessToken, userName, repos) => {
  ...
  console.log("Object.keys(PRCommentsData)=>",Object.keys(PRCommentsData[1]));
  ...
  console.log("typeof IssuesComments",typeof issuesCommentsData);
  console.log("Object.keys(IssuesComments)=>",Object.keys(issuesCommentsData[0]));
